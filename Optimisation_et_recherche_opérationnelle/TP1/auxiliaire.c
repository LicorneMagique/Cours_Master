...
//////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////   implementer la procedure free_nodl   /////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
// free_nodl qui libère entièrement l’espace mémoire occupé par une liste de noeuds, donnée par un pointeur vers la liste. Attention, il faut libérer l’espace occupé par chacune des cellules de la liste !
...
//////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////   implementer la procedure free_graph   ////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
...
int rand_imp(int a) {
  ...
  if (a > RAND_MAX) {
    report_error("Function rand_imp asks for a random integer possibly greater than RAND_MAX.\n");
  } else if (a == RAND_MAX) {
    tir = rand();
    pas = 1;
  } else if (a < RAND_MAX) {
